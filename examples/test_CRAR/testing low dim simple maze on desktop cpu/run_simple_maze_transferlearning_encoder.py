...
from testing_inverse_env_from_start.simple_maze_env_diff_obs import MyEnv as simple_maze_env ####inverse obs
...
class Defaults:
    ...
    # ----------------------
    UPDATE_RULE = 'rmsprop'
    LEARNING_RATE = 0.00015 #TODO define a good learning rate for transfer learning encoder (not too instable but still able to learn encoder)
...
if __name__ == "__main__":
    ...
    agent._learning_algo.freezeAllLayersExceptEncoder() #TODO experiment with clean encoder
